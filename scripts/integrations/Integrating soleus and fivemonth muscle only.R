sol_soupx_muscle <- subset(sol_soupx, idents = c("Type I Myonuclei", "Type IIx Myonuclei", "Type IIa Myonuclei", "Musculotendinous Junction", "Satellite Cells"))
fivemonth_soupx_muscle <- subset(fivemonth_soupx, idents = c("Neuromuscular Junction", "Type IIx Myonuclei", "Type IIb Myonuclei", "Musculotendinous Junction", "Satellite Cells"))
